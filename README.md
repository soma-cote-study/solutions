...
## 주차별 유형 및 진행 현황
| 주차  | 유형 | 김소희 | 나원빈 | 심유진 | 이하영 |
|-------|------|--------|--------|--------|--------|
| 1주차 | 구현, 조합, 유니온파인드, SQL | ✅✅ | ✅✅ | ✅✅ | -- |
| 2주차 | DFS/BFS, 그래프, SQL |✅✅ |✅✅ |✅✅ |✅✅ |
| 3주차 | DFS/BFS, 그래프(다익스트라/플로이드/벨만포드), Deque/큐, SQL |✅✅  |✅✅ |✅✅  |✅✅  |
| 4주차 | DFS/BFS, 그래프(다익스트라/플로이드/벨만포드), 백트래킹, SQL |✅✅  |✅✅  |✅✅  |✅✅  |
| 5주차 | 복습 주차 |✅✅  |✅✅  |✅✅  |✅✅  |
| 6주차 | DP, 분할정복, 자료구조, SQL |✅  |⭕  |✅  |✅  |
| 7주차 | DP, 완전탐색, 수학, SQL |  |  |  |  |
| 8주차 | 그리디, 이분탐색, SQL |  |  |  |  |
| 9주차 | 정렬, 비트마스킹, SQL |  |  |  |  |
| 10주차 | 복습 주차 |  |  |  |  |

> 진행 현황 표는 매주 수요일과 일요일에 PR이 업로드된 후에 업데이트 됩니다.
...
> 
> (예: "✅⭕" → 수요일 모든 문제 풀이 완료, 일요일 일부 문제 풀이 완료)
